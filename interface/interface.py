...
class Interface:
    ...
    def newcustomer(self, header=None):
        ...
        data = {
            "preUserName": "",
            "preUserId": "",
            "preDate": "null", "preRemark": "",
            "preId": "", "photoUrl": "",
            "sex": 2, "name": "u9", "nickName": [],
            "phoneNumber": [{"phoneNumber": "17311330109", "ismain": "true"}],
            "storeId": "", "sourceType": 5,
            "sourceTypeOldNew": "",
            "sourceTypeUserId": "",
            "sourceTypeOther": "",
            "sourceTypeRemark": "",
            "sysUserId": "9d84c6ac6e0d2696ba815c935408417e",
            "customerPoolType": 1,
            "poolId": "0e61d5093b6ce4488e3835854af66fb7",
            "birthday": "", "age": "", "marriedFlag": "null",
            "fertilityFlag": "null", "area": [], "sourceTypeDetailType": "",
            "allergyLabels": [],
            "personalityLabels": [],
            "associatedDoctors": [],
            "relatedDoctors": [], "relatedServices": [],
            "relatedConsultants": []
        }
        data['name'] = f.name_male ()
        # data1 = data['name']
        data['phoneNumber'][0]['phoneNumber'] = f.phone_number ()
        # data2 = data['phoneNumber'][0]['phoneNumber']
        # print(data1,data2)
    ...
    def order(self, header=None):
        ...
        data = '{"anaesthesia":"[]","fileId":"[]","startTime":"2020-01-03 17:00:00","endTime":"2020-01-03 17:30:00","expertId":"c0cb8e33ab2f1e0e3cf7b7a2a55eb01f","expertName":"YT","customerId":"06c71785f7ab3e505cdeda1ce0511bf3","bespeakTypeValue":"1","bespeakTypeName":"咨询","bespeakTypeColor":"#98d8a6","operationFlag":false,"inviteId":"9d84c6ac6e0d2696ba815c935408417e","inviteName":"YT","bespeakUserId":"9d84c6ac6e0d2696ba815c935408417e","bespeakUserName":"YT","bespeakProject":[{"dataType":1,"dataId":"04a4a7b39efb6221db26b9ea3bfebd2a","dataName":"皮肤科"}]}'
        data = data.encode ()
        method = 'post'
        response = RunMain ().run_main (method=method, url=url, data=data, header=header)
        return response
